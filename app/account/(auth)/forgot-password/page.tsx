...
export const metadata: Metadata = {
  ...
  description:
    'Reset your EcoFila account password securely. Recover access to manage your profile, track healthy grocery orders, and continue shopping fresh, natural, and sustainable products with ease.',
};
